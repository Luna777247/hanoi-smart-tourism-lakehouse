...
Khởi chạy mọi thứ bao gồm Trino, Clickhouse, và công cụ giám sát Prometheus/Grafana (Chỉ dành cho máy cấu hình mạnh).
**🖥️ Windows:**
```powershell
.\manage_infra.ps1 -Action start-full
```
