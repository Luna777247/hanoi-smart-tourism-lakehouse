"""
Airflow Webserver Configuration with Keycloak OAuth2 Authentication
"""
import os
import logging
...
class KeycloakSecurityManager(FabAirflowSecurityManagerOverride):
    """
    Custom Security Manager for Airflow with Keycloak OAuth2
    Maps Keycloak roles to Airflow roles
    """
    ...
    def oauth_user_info(self, provider, response=None):
        ...
        if provider == 'keycloak':
            try:
                ...
                # Airflow roles: Admin, Op, User, Viewer, Public
